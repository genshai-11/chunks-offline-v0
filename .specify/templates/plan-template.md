...
- Domain-Led Live Learning Core: role, room, round, response, and progress loop preserved
- Supabase-First Durable Realtime State: durable Postgres state precedes realtime UI assumptions
